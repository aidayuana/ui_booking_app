...
import 'package:ui_booking_app/page/detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget placeTop() {
    return SizedBox(
      ...
      child: ListView.builder(
        itemCount: listPlaceTop.length,
        scrollDirection: Axis.horizontal,
        itemBuilder: (context, index) {
          Place place = listPlaceTop[index];
          return GestureDetector(
            onTap: () => Get.to(() => DetailPage(place: place)),
            child: Container(
              width: 300,
              margin: EdgeInsets.fromLTRB(index == 0 ? 16 : 8, 0,
                  index == listPlaceTop.length - 1 ? 16 : 8, 0),
              child: Column(
                children: [
                  Expanded(
                    child: Stack(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            width: 150,
            margin: EdgeInsets.fromLTRB(index == 0 ? 16 : 8, 0,
                index == listUser.length - 1 ? 16 : 8, 0),
            decoration: BoxDecoration(
  ...
  Widget placeNear() {
    return SizedBox(
      height: 180,
      child: ListView.builder(
        itemCount: listPlaceNear.length,
        scrollDirection: Axis.horizontal,
        itemBuilder: (context, index) {
          Place place = listPlaceNear[index];
          return GestureDetector(
            onTap: () => Get.to(() => DetailPage(place: place)),
            child: Container(
              width: 300,
              margin: EdgeInsets.fromLTRB(index == 0 ? 16 : 8, 0,
                  index == listPlaceNear.length - 1 ? 16 : 8, 0),
              child: Stack(
                children: [
                  ClipRRect(
                    borderRadius: BorderRadius.circular(16),
